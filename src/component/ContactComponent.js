...
class Contact extends Component{
    ...
    handleSubmit(value){
        ...
        //this.props.addFeedback(value.firstname,value.lastname,value.telnum,value.email,value.contactType,value.agree,value.message)
    ...
    //         errors.firstname='First Namme Should be >= 3 character';
    //     else if( this.state.touched.firstname && firstname.length>10)
    //         errors.firstname='First Name should be <= 10 character';
    //     //last NAMe
    //     if(this.state.touched.lastname && lastname.length<3)
    //         errors.lastname='Last Namme Should be >= 3 character';
    ...
    //         errors.telnum='Tel.Number should conntain only number';
